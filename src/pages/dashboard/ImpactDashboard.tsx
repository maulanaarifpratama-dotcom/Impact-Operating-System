    ...
    return (
      <div className="flex h-[70vh] items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          <Loader2 className="h-10 w-10 animate-spin text-[#155F66]" />
  ...
  return (
    <div className="container mx-auto space-y-8 p-4 md:p-6 max-w-6xl">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b pb-6 border-slate-100 dark:border-slate-800">
        <div>
          <h1 className="text-3xl font-extrabold tracking-tight text-[#0F3D4F] dark:text-white">
            Executive Summary
          </h1>
        ...
        <div className="flex flex-wrap items-center gap-2">
          {organization && (
            <Badge className="bg-[#155F66] text-white px-3 py-1 text-xs font-semibold hover:bg-[#155F66]/90">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="border border-slate-150 shadow-elegant bg-white dark:bg-slate-950 flex flex-col justify-between">
          ...
          <CardContent className="space-y-6">
            <div className="flex items-baseline gap-2">
              <span className="text-3xl font-black text-[#155F66] dark:text-teal-400 whitespace-nowrap">
            ...
            {metrics.highestSroiRatio > 0 ? (
              <div className="space-y-4">
                ...
                <div className="p-3 bg-teal-500/5 border border-teal-500/10 rounded-lg">
                  <span className="text-[10px] font-extrabold text-[#155F66] block uppercase">
                    Program Terbaik
                  </span>
        ...
        <Card className="border border-slate-150 shadow-elegant bg-white dark:bg-slate-950 flex flex-col justify-between">
          <CardHeader className="pb-4">
            <CardTitle className="text-sm font-bold uppercase tracking-wider text-[#155F66] flex items-center gap-1.5">
            ...
            {metrics.nextActions.length > 0 ? (
              metrics.nextActions.map((action, i) => (
                <Link
                  key={i}
                  to={action.href}
                  className="flex items-center justify-between p-3 rounded-lg border border-slate-100 hover:border-[#155F66] hover:bg-slate-50/50 dark:border-slate-800 dark:hover:border-teal-500 dark:hover:bg-slate-900/50 transition-all group"
                >
                  ...
                  <ChevronRight className="h-4 w-4 text-slate-400 group-hover:text-[#155F66] dark:group-hover:text-teal-400 transition-all" />
                </Link>
              ))
            ) : (
