          ...
          return (
                  <Card>
                          <CardContent className="py-12 text-center">
                                    <p className="text-muted-foreground">Proyek tidak ditemukan.</p>p>
                                    <Button asChild variant="link">
                                                <Link to="/dashboard/grant-writer">Kembali ke daftar proyek</Link>Link>
                                    </Button>Button>
                ...
                <div className="min-w-0 flex-1 space-y-6">
                        <div className="flex flex-wrap items-start justify-between gap-3">
                                  <div className="min-w-0">
                                              ...
                                              <h1 className="truncate text-h2">{project.title}</h1>h1>
                        ...
                        <Card>
                                  <CardHeader>
                                              <CardTitle className="text-lg">{stepMeta.label}</CardTitle>CardTitle>
                                              <p className="text-sm text-muted-foreground">{stepMeta.description}</p>p>
                                  </CardHeader>CardHeader>
                                  <CardContent>{renderStep()}</CardContent>CardContent>
                        </Card>Card>
