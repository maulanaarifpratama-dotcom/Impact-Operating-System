...
export default function GrantWriterProposal() {
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      if (!projectData && (projectId === '750bbb67-a9a6-435e-821d-7de86b3136e8' || projectId === 'demo')) {
        projectData = {
      ...
      if (!documentData && (projectId === '750bbb67-a9a6-435e-821d-7de86b3136e8' || projectId === 'demo')) {
        documentData = {
