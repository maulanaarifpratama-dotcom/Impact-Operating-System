      ...
      <section className="py-16 sm:py-24 border-b border-white/5 relative z-10">
        <div className="container max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 items-stretch">
            ...
            {/* Tier 1 — Gratis */}
            <Card className="bg-[#0E2833]/40 border-white/5 hover:border-white/10 transition-all rounded-3xl p-6 sm:p-8 flex flex-col justify-between h-full shadow-xl">
              <div>
            ...
            <div className="relative group flex flex-col h-full">
              <div className="absolute -inset-1 bg-gradient-to-b from-teal-500 to-[#1D7A75] rounded-3xl blur opacity-30 group-hover:opacity-40 transition-opacity" />
              <Card className="relative bg-[#0E2833] border-teal-500/30 rounded-3xl p-6 sm:p-8 flex flex-col justify-between h-full shadow-2xl scale-100 md:scale-105 border-2">
                <div>
                  <div className="flex justify-between items-center gap-2">
                    <span className="text-xs font-bold text-teal-400 uppercase tracking-wider">Plan Menengah</span>
                    <Badge className="bg-gradient-to-r from-teal-500 to-[#1D7A75] text-white px-2.5 py-1 text-[10px] font-bold uppercase rounded-lg border-none">
                      Paling populer
                    </Badge>
                  </div>
                  <div className="mt-5">
                ...
                <Button asChild className="w-full bg-gradient-to-r from-teal-500 to-[#1D7A75] hover:from-teal-600 hover:to-teal-700 text-white font-bold rounded-xl py-6 mt-8 text-xs shadow-lg shadow-teal-500/20">
