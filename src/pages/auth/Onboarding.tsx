...
export default function Onboarding() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-[#0F3D4F] via-[#155F66] to-[#1D7A75] px-4 py-12 md:px-8">
      ...
      <div className="relative z-10 w-full max-w-xl">
        ...
        <div className="rounded-2xl border border-white/10 bg-[#0F3D4F]/60 p-6 shadow-elegant backdrop-blur-xl md:p-8 text-white">
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-5">
            ...
            <div className="grid gap-1.5">
              ...
              >
                ...
                <SelectContent className="bg-[#0F3D4F] border-white/10 text-white">
                  {SECTORS.map((s) => (
                    <SelectItem
                      key={s.value}
                      value={s.value}
                      className="hover:bg-[#155F66]/60 focus:bg-[#155F66]/60 focus:text-white"
                    >
                      {s.label}
                    </SelectItem>
                  ))}
