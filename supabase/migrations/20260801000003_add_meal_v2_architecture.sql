...
-- Description: Add indicator_type, aggregation_method, verification_state, and Evidence Bridge linkage to lfa_meal_items and meal_tracking_entries per ADR-0006 for Sprint 4 MEAL V2.
...
-- 2. Add Evidence Bridge and Verification columns to meal_tracking_entries
ALTER TABLE public.meal_tracking_entries
...
CREATE INDEX IF NOT EXISTS idx_meal_tracking_entries_wbs_evidence_id ON public.meal_tracking_entries(wbs_evidence_id);
CREATE INDEX IF NOT EXISTS idx_meal_tracking_entries_verification_state ON public.meal_tracking_entries(verification_state);
