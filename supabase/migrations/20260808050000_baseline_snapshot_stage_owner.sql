-- Migration: 20260808050000_baseline_snapshot_stage_owner.sql
-- Description: Update create_project_baseline to include stage_owner in
--   the snapshot JSONB for Stage accountability tracking.
